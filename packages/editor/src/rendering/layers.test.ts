...
describe('LAYER_IDS', () => {
  it('contains all expected layer IDs', () => {
    const expected = ['BUILDING_FILL', 'BUILDING_OUTLINE', 'ROOM_FILL', 'ROOM_OUTLINE', 'HALLWAY_LINE', 'ROAD_OUTLINE', 'ROAD_FILL', 'ENTRANCE_ICON', 'STAIRCASE_ICON', 'ELEVATOR_ICON', 'PANORAMA_ICON', 'QR_ICON', 'SELECTION_OVERLAY', 'HOVER_HIGHLIGHT', 'PREVIEW', 'VALIDATION_OVERLAY']
