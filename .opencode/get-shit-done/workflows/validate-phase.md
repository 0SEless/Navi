...
```
Agent(
  prompt="Read C:/Users/Administrator/Desktop/CODEme/Navi/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Administrator/Desktop/CODEme/Navi/.opencode/get-shit-done/templates/VALIDATION.md`
