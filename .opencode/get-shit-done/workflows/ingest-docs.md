...
```bash
INIT=$(node "C:/Users/Administrator/Desktop/CODEme/Navi/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/Administrator/Desktop/CODEme/Navi/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
