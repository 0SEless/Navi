...
- **Global scope**: `C:/Users/Administrator/Desktop/CODEme/Navi/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Administrator/Desktop/CODEme/Navi/.opencode/notes/`)
...
2. Glob `C:/Users/Administrator/Desktop/CODEme/Navi/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Administrator/Desktop/CODEme/Navi/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Administrator/Desktop/CODEme/Navi/.opencode/notes/` — works in any directory
