...
```bash
INIT=$(node "C:/Users/Administrator/Desktop/CODEme/Navi/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/Administrator/Desktop/CODEme/Navi/.opencode/get-shit-done/templates/spec.md.
