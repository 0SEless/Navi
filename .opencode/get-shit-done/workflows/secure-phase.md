...
```
Agent(
  prompt="Read C:/Users/Administrator/Desktop/CODEme/Navi/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Administrator/Desktop/CODEme/Navi/.opencode/get-shit-done/templates/SECURITY.md`
