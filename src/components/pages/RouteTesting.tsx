...
import { MOCK_NODES, MOCK_EDGES, NODE_COLORS, calcDistance } from "@/components/map-editor/mockData";
import type { NavNode, NavEdge, NodeType } from "@/components/map-editor/types";
          ...
          <div style={{ flex: 1, overflowY: "auto" }}>
            {routeResult ? (
              ...
              <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24, textAlign: "center", gap: 10 }}>
                <Route size={24} color="#1C6BEB" style={{ opacity: 0.4 }} />
