-- Migration: fix_graph_sync_null_building_id
-- Fix B3: corridor nodes with empty buildingId string caused FK violation.
-- Changed n->>'buildingId' → NULLIF(n->>'buildingId', '') so empty strings
-- become NULL instead of attempting to insert '' as a FK reference.
